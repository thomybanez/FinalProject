...
50.times do
  Client.create!(
    email: "#{rand(10_000)}@example.com",
    password: "password#{rand(10_000)}",
    contact_number: "+1-555-#{rand(100..999)}-#{rand(1000..9999)}",
    nick_name: "Client#{rand(10_000)}",
    age: rand(18..65),
...
50.times do
  Performer.create!(
    ...
    password: "password#{rand(10_000)}",
    contact_number: "+1-555-#{rand(100..999)}-#{rand(1000..9999)}",
    stage_name: "Performer#{rand(10_000)}",
    age: rand(18..65),
    gender: %w[Male Female Non-binary].sample,
    location: "City#{rand(10)}",
    description: "Description #{rand(10_000)}",
    ratings: rand(1..5),
    availability: %w[Full-time Part-time].sample
  )
end
